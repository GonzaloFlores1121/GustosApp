    ...
    IUsuarioRepository usuarios)
{
    public async Task<Guid> HandleAsync(string firebaseUid, Guid restauranteId, CancellationToken ct, DatosReclamo? datos = null)
    {
        ...
        var solicitud = new SolicitudRestaurante
        {
            ...
            NombreSolicitante = datos.NombreSolicitanteNormalizado,
            RelacionRestaurante = datos.RelacionRestauranteNormalizada,
            TelefonoContacto = datos.TelefonoContactoNormalizado,
